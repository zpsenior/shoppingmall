...
public class APayUserCreditScoreRequest extends APayRequest {

	public APayUserCreditScoreRequest() {
		super("zhima.credit.score.brief.get");
	}
	...
	protected void addFields(TreeMap<String, Object> bean) {
		...
		bean.put("name", name);
		bean.put("admittance_score", admittance_score);
	}
